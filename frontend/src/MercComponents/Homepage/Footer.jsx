          ...
          <li key={link.label}>
            {link.to ? (
              ...
              <button
                ...
                style={{ background: "none", border: "none", padding: 0, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontSize: 15, color: "rgba(255,255,255,0.35)", textDecoration: "none", transition: "color 200ms", textAlign: "left" }}
                onMouseEnter={e => e.currentTarget.style.color = "#ec5b13"}
                onMouseLeave={e => e.currentTarget.style.color = "rgba(255,255,255,0.35)"}
              >{link.label}</button>
            )}
                ...
                {links.map(link => (
                  <li key={link.label}>
                    {link.to ? (
                      ...
                      >
                        {link.label}
                        <span style={{ marginLeft:4, fontFamily:"'JetBrains Mono',monospace", fontSize:8, color:"rgba(236,91,19,0.5)", verticalAlign:"middle" }}>ⓘ</span>
                      </button>
                    )}
                  </li>
                ))}
