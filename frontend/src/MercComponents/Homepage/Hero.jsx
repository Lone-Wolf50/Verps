const Hero = () => {
	return (
		<header className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-background-dark">
			...
			{/* Fixed Centered Arrow */}
			{/* Using inset-x-0 and justify-center ensures it stays exactly in the middle away from buttons */}
			<div className="absolute bottom-6 inset-x-0 flex justify-center animate-bounce opacity-30 z-20 pointer-events-none">
